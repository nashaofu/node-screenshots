...
impl Image {
  ...
  #[napi]
  pub fn to_png_sync(&self, env: Env, copy_output_data: Option<bool>) -> Result<Buffer> {
  ...
  #[napi]
  pub fn to_jpeg_sync(&self, env: Env, copy_output_data: Option<bool>) -> Result<Buffer> {
  ...
  #[napi]
  pub fn to_bmp_sync(&self, env: Env, copy_output_data: Option<bool>) -> Result<Buffer> {
  ...
  #[napi]
  pub fn to_raw_sync(&self, env: Env, copy_output_data: Option<bool>) -> Result<Buffer> {
