...
async function main() {
  ...
  saveImage(`image-crop-${monitor.id()}.png`, (await image.crop(100, 100, 300, 300)).toPngSync())
  saveImage(`image-crop-sync-${monitor.id()}.png`, image.cropSync(100, 100, 300, 300).toPngSync())
  ...
  runWithTime(() => image.cropSync(100, 100, 300, 300), 'image.cropSync(100, 100, 300, 300)')
}
